...
public final class ItemCarBinding implements ViewBinding {
  ...
  private ItemCarBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgCar,
      @NonNull TextView tvCarName) {
  ...
  public static ItemCarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCarBinding((LinearLayout) rootView, imgCar, tvCarName);
    }
